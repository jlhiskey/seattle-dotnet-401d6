...
namespace EFStudentEnrollment.Controllers
{
    public class TranscriptsController : Controller
    {
        ...
        public TranscriptsController(SchoolEnrollmentDbContext context)
        {
            _context = context;
        }
        ...
        {
            var schoolEnrollmentDbContext = _context.Transcripts.Include(t => t.Course).Include(t => t.Student);
            return View(await schoolEnrollmentDbContext.ToListAsync());
        }
