...
using EFStudentEnrollment.Models.ViewModels;
using EFStudentEnrollment.Models.Interfaces;

namespace EFStudentEnrollment.Controllers
{
    public class StudentController : Controller
    {
        private readonly IStudentManager _context;

        public StudentController(IStudentManager context)
        {
            _context = context;
        }
       ...
       // GET: Student
        ...
        public async Task<IActionResult> Create(StudentCreateViewModel student2)
        {
            Student newStudent = student2.Student;
            if (ModelState.IsValid)
            {
                await _context.CreateStudent(newStudent);
